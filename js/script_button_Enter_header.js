...
const buttonInFormAuthheader=document.querySelector('.tablinks');
let i=0;
...
////querySelectorAll включает все найденные элементы документа, которые соответствуют указанному селектору.

/*addEventListener - позволяет повесить несколько обработчиков на одно событие. 
Например, одна часть кода хочет при клике на кнопку делать её подсвеченной, а другая – выдавать сообщение.
removeEventListener - Для удаления обработчика*/

const buttonInFormAuthheader_2=document.querySelector('.button-red');
...
buttonInFormAuthheader_2.addEventListener('click', () => {      //click – происходит, когда кликнули на элемент левой кнопкой мыши
	...
	console.log("Так с.. зашли в myFunction..")
	const c1 = document.querySelector(".Sign-in_login");  //возвращает первый элемент (Element) документа, который соответствует указанному селектору или группе селекторов.
    const d1 = document.querySelector(".Sign-in_password");
    console.log('c1', c1)
    console.log('d1', d1)
   	
	if (c1.value.length > 0 && d1.value.length> 0) {
...
const buttonInFormAuthheader_4=document.querySelector('.close');

   console.log('buttonInFormAuthheader_4', buttonInFormAuthheader_4)

buttonInFormAuthheader_4.addEventListener('click', () => {      //click – происходит, когда кликнули на элемент левой кнопкой мыши
...
/*document.addEventListener( 'click', (e) => {
	if (e.composedPath()[0].attributes[0].nodeValue === "zatemnenie_enter_3"){
